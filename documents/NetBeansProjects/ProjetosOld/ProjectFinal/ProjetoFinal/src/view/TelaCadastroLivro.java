...
public class TelaCadastroLivro extends javax.swing.JFrame {
 ConexaoBD conex=new ConexaoBD();
   ...
   String editora;
    ...
    isbn=jFormattedTextField6.getText();
    titulo=jTextField4.getText();
    autor=jTextField6.getText();
    subtitulo=jTextField5.getText();
    editora=jTextField5.getText();
jTextField1.setText("");
...
jTextField5.setText("");
        ...
        conex.conexao();
        try {
            PreparedStatement pst=conex.con.prepareStatement("INSERT INTO cad_Livro VALUES(?, ?, ?, ?, ?, ?)");
            pst.setString(1, id);
            pst.setString(2, isbn);
            pst.setString(3, titulo);
            pst.setString(4, autor);
            pst.setString(5, subtitulo);
            pst.setString(6, editora);
